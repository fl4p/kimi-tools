<!-- Extracted from Kimi.app 3.0.19 (kimi_3.0.19.dmg) for research. The repo
maintainer does not claim copyright. Kimi desktop bundles a rebranded build of
the third-party 'OpenClaw' assistant framework. -->
